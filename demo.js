var demo = (function () {
  ...
  var SexyYamlType = new jsYmalExceptional.Type('!sexy', {
  ...
  var SEXY_SCHEMA = jsYmalExceptional.DEFAULT_SCHEMA.extend([ SexyYamlType ]);
  ...
  function parse() {
    ...
    try {
      obj = jsYmalExceptional.load(str, { schema: SEXY_SCHEMA });
